...
class FuzzyGui:
    ...
    def calculate_health_care(self):
        try:
            ...
            toolbox.register("individual", tools.initRepeat, creator.Individual, toolbox.rule_strength,
                             n=len(rules))  # Adjust the number of rules
            ...
            def evaluate(individual):
                ...
                health_care_simulation.input['Diastolic Blood Pressure'] = diastolic_value
                health_care_simulation.input['Systolic Blood Pressure'] = systolic_value
                health_care_simulation.input['Temperature'] = temperature_value
            ...
            algorithms.eaMuPlusLambda(population, toolbox, mu=population_size, lambda_=population_size,
                                      cxpb=0.7, mutpb=mutation_rate, ngen=num_generations, stats=None, halloffame=None,
                                      verbose=True)
            ...
            self.result_label.config(text=("Health Care: ",output))
